...
Scenario: Should support scenario description
	Given there is an excel file 'SimpleConcat.xlsx' with a spreadsheet 'Simple scenario'
		| In this | feature | we want      | to test the support of the scenario description |
		| When    | I       | do something | useful                                          |
	When the excel file is processed 
	Then the generated feature is equivalent to
		"""
		Feature: SimpleConcat
...
Scenario: Should support multiline scenario description
	Given there is an excel file 'SimpleConcat.xlsx' with a spreadsheet 'Simple scenario'
		| In this | feature     | we           | want                 |
		| to test | the support | of the       | scenario description |
		| When    | I           | do something | useful               |
	When the excel file is processed 
	Then the generated feature is equivalent to
		"""
